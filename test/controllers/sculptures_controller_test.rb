...
class SculpturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sculpture" do
    assert_difference('Sculpture.count') do
      post sculptures_url, params: { sculpture: { copyright: @sculpture.copyright, credit: @sculpture.credit, description: @sculpture.description, slug: @sculpture.slug, title: @sculpture.title } }
    end
  ...
  test "should update sculpture" do
    patch sculpture_url(@sculpture), params: { sculpture: { copyright: @sculpture.copyright, credit: @sculpture.credit, description: @sculpture.description, slug: @sculpture.slug, title: @sculpture.title } }
