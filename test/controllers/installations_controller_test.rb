...
class InstallationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create installation" do
    assert_difference('Installation.count') do
      post installations_url, params: { installation: { comment: @installation.comment, copyright: @installation.copyright, credit: @installation.credit, description: @installation.description, title: @installation.title } }
    end
  ...
  test "should update installation" do
    patch installation_url(@installation), params: { installation: { comment: @installation.comment, copyright: @installation.copyright, credit: @installation.credit, description: @installation.description, title: @installation.title } }
